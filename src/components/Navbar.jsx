    ...
    <header className="flex items-center justify-between ">
      ...
      <nav className="mr-4 mt-3 font-font2 font-medium md:mr-10 md:mt-6 ">
        <ul className="flex list-none items-center ">
          ...
          <li className="mx-6  flex cursor-pointer items-center justify-center rounded-md border-2 border-solid border-white bg-black bg-opacity-10 px-5 py-2 transition-all  duration-300 ease-in-out hover:-translate-y-0.5 hover:border-blue2 hover:bg-blue2 ">
            LET'S TALK
          </li>
